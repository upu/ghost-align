...
- Added default `"="` alignment for Terraform/HCL, Protocol Buffers (proto3), Elixir, and Perl, with correct line-comment handling for each (`#` and `//` for Terraform/HCL, `#` for Elixir and Perl).
